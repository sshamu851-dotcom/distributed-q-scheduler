...
class QAgent:
    def __init__(self, num_workers=3, state_buckets=5, alpha=0.6, gamma=0.9, eps_start=0.3, eps_min=0.02, eps_decay=0.999):
    ...
    def update(self, state, action, reward, next_state):
        ...
        self.Q[state][action] = q_current + self.alpha * (reward + self.gamma * q_next_max - q_current)
